...
public class SharedPref {
    ...
    public static List<Task> jsonStringtoTaskList(String json_read) throws JSONException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            for (int sub_i = 0; sub_i < subtaskJSONArray.length(); sub_i++) {
                ...
                Log.e("SubName", subTaskObject.getName());
                Log.e("SubtaskObject", subtaskJSONObject.toString());
                indexTask.setSubtasks(subtaskList);
                Log.e("AAAINLOOP", indexTask.getSubtasks().toString());
            }
            Log.e("AAAOUT", indexTask.getSubtasks().toString());
            TaskList.add(indexTask);
            Log.e("CLEARING.", ";");
            subtaskList.clear();
        }
        Log.e("TaskList Size", "" + TaskList.size());
        Log.e("TaskList Sub", "" + TaskList.get(0).getSubtasks());
        return TaskList;
    }
    ...
    private static LocalDate createLocalDateFromJson(JSONObject dueDate) {
        ...
        try {
            ...
            Log.e("LOCAL ASDJGALSDGJK", localDateString);
